...
!-- Author: ywatanabe
!-- File: /home/ywatanabe/.dotfiles/.claude/to_claude/guidelines/.guidelines-programming-Cleanup-Rules.md
!-- --- -->
...
1. Review Clean Code Rules: `./docs/to_claude/guidelines/.guidelines-programming-Clean-Code-Rules.md`
